...
Well, it's been a couple of weeks (I was a bit offline last weekend). So I'm back at it and, first, I needed to clean things up. It just was messy code.
...
As it turns out, in fixing the code, I made the learning **worse**... It still kind-of works, but form the last few runs, it... **well, it feels it learns worse**.
