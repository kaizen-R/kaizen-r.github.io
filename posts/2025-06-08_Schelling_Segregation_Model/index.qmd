...
One such social model is the "classic" computational model of Schelling (1978). I'm not a fan of the concept it illustrates (coming from racial segregation, it's not great). But the thing is, the emergent behavior of some level of self-organization is interesting, in-as-much there is no central push here for organization, just agents preferences "playing out".
