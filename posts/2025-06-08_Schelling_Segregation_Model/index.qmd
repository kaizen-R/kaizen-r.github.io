...
author: "Nico"
date: "2025-06-08"
categories: [Decision, Optimization, visualization]
---
...
One such social model is the "classic" computational model of Schelling (1978). I'm not a fan of the concept it illustrates (supposedly related to some concept of racial segregation, it's not great). But the thing is, the emergent behavior of some level of self-organization is interesting, in-as-much there is no central push here for organization, just agents preferences "playing out".
...
And with just the agents' preferences, you can probably already guess what will happen. But the fun part is, there will be organization, even though **none** of the agents prefers to have a **majority** of the same type of agents. And yet...

Here the resulting animation:
