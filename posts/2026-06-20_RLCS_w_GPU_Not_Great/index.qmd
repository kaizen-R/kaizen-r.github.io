...
-   copying of data to the GPU. Now I thought, at least on my Macbook Air M1, that would be marginally worse, as supposedly CPU and GPU share the memore on the SoC. Apparently, lucky me, it does, **but it actually gets better with M2 and onwards**... I purposefully avoid buying new hardware for now (waiting for M6, hopefully, the 2nm thing...), so of course on M1 it's well, not great...
