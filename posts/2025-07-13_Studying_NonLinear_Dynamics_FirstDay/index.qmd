...
> **"A first order ODE can be understood as gradient descent."**
...
I should have **known (!!)** that the integral corresponding to that ODE, the one that negates the gradient hereby represented, is in fact:
...
![Wrapping my head around vector fields](images/IMG_6596 copy.jpeg)
