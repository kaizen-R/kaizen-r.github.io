...
-   Or find out that the dataset cannot be broken the way we have initially chosen, indicating possible "epistasis", which in itself would be interesting and would hav ejust supposed a few seconds lots here.
