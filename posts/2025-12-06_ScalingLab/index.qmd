...
Alright, so I have this miniPC with 16 threads, a for the past weeks I was looking at my MacBook M1 screen while waiting for 7 parallel processes to run... And because I was testing different configurations and doing a sort-a Monte-Carlo, whereby I would run 50 times each configuration (to compare accuracy with RF, Rpart and now also a simple NeuralNet), but each complicated config I would use for RLCS would take 40s-1m20s, times 50, well...
