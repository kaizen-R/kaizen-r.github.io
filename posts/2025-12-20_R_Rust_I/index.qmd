...
I don't think anyone is going to be using R to code games or OS components, so there is that. But, being a computer scientist by training (a long time ago), I sometimes miss the more involved stuff.
