...
![Book Cover for "Strategy, a History" (see resources)](Strategy book cover.png){fig-align="center" width="300"}
...
And that "simil" I think is key. Binary is in the end the minimal level of encoding for information AND for decisions, and maybe then it **kinda makes sense that information is hence just a support for decision**.
...
-   Cybernetics. Now this is far from a perfect match here, I know. But in concept, a captain that steers a boat pushes in one direction, but you **can't perfectly** indicate an **exact** direction, so in that sense you have a lot of influence, yes, but there is some... wiggle? uncertainty? And although I understand I am being fuzzy in my juxtaposition of these ideas here, well, it also agrees with the fact that although you can have an impact on the overall direction of things, no decision will here be perfect as you cannot have a perfect impact.

-   And the second idea, is Asimov's "Psycho-History". I've always loved the original trilogy of the Foundations (not the TV adaptation...). The very concept of psycho-history is resounding when reading these concepts by Tolstoi as introduced above... Which I found interesting.

What these things are saying, put together, is I guess this: Say in a large company.

One boss can make "strategic" decisions. But how much of that translates into a perfectly aligned (maybe more tactical) action? Does anyone know what such an action could/should be (and that's the job of managers and employees, you could argue)? Would context accompany, at all?
...
Would the whole team of many people ever be perfectly aligned with said action or actions? I guess not, and the ideas of Chaos and Complex Systems are supporting my view here. Do they (the whole team) actually need to be "perfectly" aligned, one might wonder...?
...
Somewhat related is the topic of the decision making itself and information, and the topic of simulations. And whenever I think of simulations these days, I think about Monte-Carlo, Reinforcement Learning, and the likes.
