...
![IDs as merging/joining datapoints](IDs%20for%20linking%20nodes.png)
...
Not, at least, as I just simply described right above. You can generate subgraphs for instance, removing nodes, but that removes as well the corresponding edges.
...
Here you can see how there are too many nodes that I wouldn't quite know how to use directly with cybersecurity news.
...
Now "Domains" and "Servers", both that were linked to "Pre-compromise" through techniques identifiers, are directly linked to the node, as I wished.
